<template>
  <div class="flex flex-col items-center gap-4 p-4 rounded-lg shadow-xl md:grid md:grid-cols-2 md:gap-8 md:p-8 bg-secondary-light dark:bg-secondary-dark scroll-transition">
    <img
