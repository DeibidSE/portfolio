  ...
  <article class="flex flex-col justify-around h-full gap-6 p-8 rounded-lg shadow-xl dark:bg-secondary-dark bg-secondary-light">
    <div class="flex flex-col w-full gap-6 xl:flex-row">
      ...
      <div class="flex flex-col items-center self-center justify-center w-full gap-4">
        <h3 class="w-full text-3xl font-bold tracking-wide text-center text-purple-500">
          {{ projectName }}
        </h3>
        ...
        <a
          ...
          role="link"
          class="flex items-center justify-center w-full px-3 py-1 transition border rounded-full shadow-xl dark:border-light border-dark gap-x-2 hover:scale-105 dark:bg-primary-dark bg-primary-light"
        >
